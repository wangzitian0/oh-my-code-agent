// Package claude is the reserved home of the Claude Code host adapter
// plugin. It is empty: no adapter is implemented here yet.
//
// Claude Code's host semantics currently live in hardcoded switches across
// the core (docs/architecture/README.md §9.1 inventories them), not behind
...
// it should.
//
// The previous doc comment said this package "implements the Claude Code
